...
# Move an existing OneDrive site to a different geo-location 

Summary: This article covers the steps for OneDrive SharePoint or Gobal Administrators to move an existing user's OneDrive to the user's new Preferred Data Location (PDL) geo. 
